package com.ncautomation.calculator.views
...
import com.ncautomation.calculator.databinding.ViewConverterBinding
    ...
    fun updateColors() {
        ...
        listOf(binding.topUnitSymbol, binding.bottomUnitSymbol).forEach {
            val drawable = ResourcesCompat.getDrawable(
                resources, com.ncautomation.commons.R.drawable.pill_background, context.theme
            )?.constantState?.newDrawable()?.mutate() as RippleDrawable
            val bgLayerList = drawable.findDrawableByLayerId(com.ncautomation.commons.R.id.button_pill_background_holder) as LayerDrawable
            val bgLayer = bgLayerList.findDrawableByLayerId(com.ncautomation.commons.R.id.button_pill_background_shape) as GradientDrawable
            bgLayer.cornerRadius = context.resources.getDimension(com.ncautomation.commons.R.dimen.rounded_corner_radius_big)
