package com.ncautomation.calculator.compose
...
import com.ncautomation.commons.compose.settings.SettingsPreferenceComponent
...
internal fun SettingsScreen(
    ...
    SimpleColumnScaffold(title = stringResource(id = R.string.settings), goBack = goBack) {
        ...
        SettingsGroup(title = {
            ...
            SettingsCheckBoxComponent(
                label = stringResource(id = com.ncautomation.calculator.R.string.use_comma_as_decimal_mark),
