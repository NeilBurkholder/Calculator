...
import com.ncautomation.calculator.databinding.WidgetConfigBinding
...
class WidgetConfigureActivity : SimpleActivity() {
    ...
    private fun initVariables() {
        ...
        if (mTextColor == resources.getColor(com.ncautomation.commons.R.color.default_widget_text_color, theme) && config.isUsingSystemTheme) {
