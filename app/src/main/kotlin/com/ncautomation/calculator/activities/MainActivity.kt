...
import com.ncautomation.calculator.BuildConfig
import com.ncautomation.calculator.R
import com.ncautomation.calculator.databases.CalculatorDatabase
import com.ncautomation.calculator.databinding.ActivityMainBinding
import com.ncautomation.calculator.dialogs.HistoryDialog
import com.ncautomation.calculator.extensions.config
import com.ncautomation.calculator.extensions.updateViewColors
import com.ncautomation.calculator.extensions.updateWidgets
import com.ncautomation.calculator.helpers.*
import com.ncautomation.commons.extensions.*
import com.ncautomation.commons.helpers.LICENSE_AUTOFITTEXTVIEW
import com.ncautomation.commons.helpers.LOWER_ALPHA_INT
import com.ncautomation.commons.helpers.MEDIUM_ALPHA_INT
import com.ncautomation.commons.models.FAQItem
import com.ncautomation.commons.models.Release
import me.grantland.widget.AutofitHelper

class MainActivity : com.ncautomation.calculator.activities.SimpleActivity(), Calculator {
    ...
    override fun onResume() {
        ...
        binding.apply {
            arrayOf(btnPercent, btnPower, btnRoot, btnClear, btnReset, btnDivide, btnMultiply, btnPlus, btnMinus, btnEquals, btnDecimal).forEach {
                it?.background = ResourcesCompat.getDrawable(resources, com.ncautomation.commons.R.drawable.pill_background, theme)
    ...
    private fun launchUnitConverter() {
        hideKeyboard()
        startActivity(Intent(applicationContext, com.ncautomation.calculator.activities.UnitConverterPickerActivity::class.java))
    }

    private fun launchSettings() {
        hideKeyboard()
        startActivity(Intent(applicationContext, com.ncautomation.calculator.activities.SettingsActivity::class.java))
    }
