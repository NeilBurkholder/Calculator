package com.ncautomation.calculator.extensions
...
import com.ncautomation.calculator.helpers.Config
import com.ncautomation.calculator.helpers.MyWidgetProvider
import com.ncautomation.calculator.interfaces.CalculatorDao
...
import com.ncautomation.commons.extensions.lightenColor
...
fun Context.getStrokeColor(): Int {
    return if (config.isUsingSystemTheme) {
        if (isUsingSystemDarkTheme()) {
            resources.getColor(com.ncautomation.commons.R.color.md_grey_800, theme)
        } else {
            resources.getColor(com.ncautomation.commons.R.color.md_grey_400, theme)
        }
    } else {
        val lighterColor = getProperBackgroundColor().lightenColor()
        if (lighterColor == Color.WHITE || lighterColor == Color.BLACK) {
            resources.getColor(com.ncautomation.commons.R.color.divider_grey, theme)
        } else {
            lighterColor
        }
    }
